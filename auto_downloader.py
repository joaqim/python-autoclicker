...
pyautogui.FAILSAFE = True # Should force exception when mouse enter top left corner

button_progress_offset_x = -120
#button_progress_offset_y = 145# + window_offset_y
button_progress_offset_y = 130
...
def download_button_detected(x, y):
    return pyautogui.pixelMatchesColor(x, y, (245, 245, 245), tolerance=20)
